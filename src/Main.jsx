  ...
  return (
    <div className="main" ref={containerRef}>
      <div className="main_header">
        <div>
          <Link to="/user/dashboard" style = {{float : "left"}}>
            <img src="./logo.png" alt="" width={30} height={30} />L o g i n
          </Link>
        </div>
        <div className="auth-links" style={{float: "right", width: "auto", whiteSpace: "nowrap"}}>
          {isAuthenticated ? (
            ...
            <>
              ...
              <Link to="/api/auth/register" className="auth-button">
                회원가입
              </Link>
            </>
          )}
      ...
      <section
        className="vertical-section text-left-section parallax-section"
        data-speed="0.1"
      >
        <div className="split-container">
          <div className="text-side">
            ...
            <p className="text-animation subheading">
              당신의 <span className="highlight">가능성</span>에 투자합니다
            </p>
            <p className="text-animation description">
              Peoch는 전통적인 신용평가를 넘어, 개인의{" "}
              <span className="highlight">성장 가능성</span>과 잠재력을 평가하여
              맞춤형 금융 서비스를 제공합니다.
            </p>
          </div>
      ...
      {/* 일반 금융과 Peoch 비교 섹션 */}
      <section
        className="vertical-section comparison-section parallax-section"
        data-speed="0.2"
      >
        <div className="text-container">
          <h2 className="text-animation heading">일반 금융 vs Peoch</h2>
          <p className="text-animation subheading">
            <span className="highlight">과거</span>가 아닌{" "}
            <span className="highlight">미래</span>를 봅니다
          </p>
        </div>
      ...
      {/* 맞춤형 금융 솔루션 섹션 */}
      <section
        className="vertical-section full-bg-section parallax-section"
        data-speed="0.15"
      >
        ...
        <div className="centered-content">
          ...
          <p className="text-animation description">
            교육, 창업, 주택 구매 등 인생의 중요한 순간에 필요한 자금을 개인 맞춤형으로 설계하여
            제공합니다.
          </p>
      ...
      {/* 커뮤니티 기반 금융 섹션 */}
      <section
        className="vertical-section text-right-section dark-section parallax-section"
        data-speed="0.25"
      >
        <div className="split-container reverse">
          <div className="image-side">
            <div className="community-images">
              <img
                src="../public/community1.jpg"
                alt="커뮤니티 1"
                className="community-img"
              />
              <img
                src="../public/community2.jpg"
                alt="커뮤니티 2"
                className="community-img"
              />
            </div>
          ...
          <div className="text-side">
            ...
            <p className="text-animation description">
              Peoch에서 비슷한 목표를 가진 사람들과 연결되어 정보를 공유하고, 서로의 성장을
              응원하세요.
            </p>
          </div>
        </div>
      ...
      {/* 투명한 금융 서비스 섹션 */}
      <section
        className="vertical-section features-section parallax-section"
        data-speed="0.3"
      >
        <div className="text-container">
      ...
      <section className="vertical-section cta-section" ref={panel2Ref}>
        <div className="cta-container">
          ...
          <p>
            "People(사람)"과 "같이(가치)"를 결합한 Peoch는 개인의 미래 성장 가능성을 기반으로 맞춤형 금융 지원을 제공합니다.
          </p>
